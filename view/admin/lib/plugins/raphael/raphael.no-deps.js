...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! eve */ "eve")], __WEBPACK_AMD_DEFINE_RESULT__ = (function(eve) {
     ...
     * Paper.upload_image
     [ method ]
     **
     * Embeds an upload_image into the surface.
     **
     > Parameters
     **
     - src (string) URI of the source upload_image
     - x (number) x coordinate position
     - y (number) y coordinate position
     - width (number) width of the upload_image
     - height (number) height of the upload_image
     = (object) Raphaël element object with type “upload_image”
     **
     > Usage
     | var c = paper.upload_image("apple.png", 10, 10, 80, 80);
    \*/
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! ./raphael.core */ "./dev/raphael.core.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function(R) {
     ...
     * or
     ...
     o fill (string) colour, gradient or upload_image
     ...
     o src (string) upload_image URL, only works for @Element.upload_image element
