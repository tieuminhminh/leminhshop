...
(function (global, factory) {
  ...
  var imageDialog = function (opt) {
      var body = '<div class="note-form-group note-group-select-from-files">' +
          ...
          '<input class="note-note-upload_image-input note-input" type="file" name="files" accept="upload_image/*" multiple="multiple" />' +
          opt.imageLimitation +
          '</div>' +
          '<div class="note-form-group" style="overflow:auto;">' +
          '<label class="note-form-label">' + opt.lang.image.url + '</label>' +
          '<input class="note-upload_image-url note-input" type="text" />' +
          '</div>';
      var footer = [
          '<button href="#" type="button" class="note-btn note-btn-primary note-btn-large note-upload_image-btn disabled" disabled>',
  ...
  $$1.extend($$1.summernote.lang, {
      'en-US': {
          ...
          image: {
              ...
              dragImageHere: 'Drag upload_image or text here',
              dropImage: 'Drop upload_image or Text',
   ...
   * @method createImage
   *
   * create `<upload_image>` from url string
   *
   * @param {String} url
   * @return {Promise} - then: $upload_image
   */
  ...
  */
      ...
      */
      ...
      Editor.prototype.insertImage = function (src, param) {
          ...
          return createImage(src, param).then(function ($image) {
              ...
              _this.context.triggerEvent('upload_image.upload.error', e);
          });
      };
      /**
       * insertImages
      ...
      Editor.prototype.insertImagesAsDataURL = function (files) {
          ...
          $$1.each(files, function (idx, file) {
              ...
              if (_this.options.maximumImageFileSize && _this.options.maximumImageFileSize < file.size) {
                  _this.context.triggerEvent('upload_image.upload.error', _this.lang.image.maximumFileSizeError);
              }
              else {
                  readFileAsDataURL(file).then(function (dataURL) {
                      return _this.insertImage(dataURL, filename);
                  }).fail(function () {
                      _this.context.triggerEvent('upload_image.upload.error');
                  });
              }
          });
      };
      ...
      Editor.prototype.insertImagesOrCallback = function (files) {
          ...
          if (callbacks.onImageUpload) {
              this.context.triggerEvent('upload_image.upload', files);
  ...
  var Clipboard = /** @class */ (function () {
      ...
      Clipboard.prototype.pasteByEvent = function (event) {
          ...
          if (clipboardData && clipboardData.items && clipboardData.items.length) {
              ...
              if (item.kind === 'file' && item.type.indexOf('upload_image/') !== -1) {
      ...
      Handle.prototype.update = function (target, event) {
          ...
          if (isImage) {
              ...
              $selection.css({
                  ...
                  width: imageSize.w,
                  height: imageSize.h
              }).data('target', $image); // save current upload_image element.
  ...
  var ImageDialog = /** @class */ (function () {
      ...
      ImageDialog.prototype.initialize = function () {
          ...
          var body = [
              ...
              '<input class="note-upload_image-input form-control-file note-form-control note-input" ',
              ' type="file" name="files" accept="upload_image/*" multiple="multiple" />',
              imageLimitation,
              '</div>',
              '<div class="form-group note-group-upload_image-url" style="overflow:auto;">',
              '<label class="note-form-label">' + this.lang.image.url + '</label>',
              '<input class="note-upload_image-url form-control note-form-control note-input ',
              ' col-md-12" type="text" />',
              '</div>',
          ].join('');
          var buttonClass = 'btn btn-primary note-btn note-btn-primary note-upload_image-btn';
      ...
      ImageDialog.prototype.show = function () {
          ...
          this.showImageDialog().then(function (data) {
              ...
              _this.ui.hideDialog(_this.$dialog);
              _this.context.invoke('editor.restoreRange');
              if (typeof data === 'string') { // upload_image url
                  // If onImageLinkInsert set,
                  if (_this.options.callbacks.onImageLinkInsert) {
                      _this.context.triggerEvent('upload_image.link.insert', data);
                  }
                  else {
      ...
      ImageDialog.prototype.showImageDialog = function () {
          var _this = this;
          return $$1.Deferred(function (deferred) {
              var $imageInput = _this.$dialog.find('.note-upload_image-input');
              var $imageUrl = _this.$dialog.find('.note-upload_image-url');
              var $imageBtn = _this.$dialog.find('.note-upload_image-btn');
              _this.ui.onDialogShown(_this.$dialog, function () {
                  _this.context.triggerEvent('dialog.shown');
  ...
  var ImagePopover = /** @class */ (function () {
      ...
      ImagePopover.prototype.initialize = function () {
          this.$popover = this.ui.popover({
              className: 'note-upload_image-popover'
          }).render().appendTo(this.options.container);
          var $content = this.$popover.find('.popover-content,.note-popover-content');
