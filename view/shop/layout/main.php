                        ...
                        <div id="wrapper">
                            <div class="slider-wrapper">
                                <div id="mainSlider" class="nivoSlider">
                                    <img src="view/shop/lib/img/slider/2.jpg" alt="main slider" title="#htmlcaption"/>
                                    <img src="view/shop/lib/img/slider/1.jpg" alt="main slider" title="#htmlcaption2"/>
                                </div>
            ...
            <div class="add-two-by-one-column">
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                    <div class="tow-column-add zoom-img">
                        <a href="#"><img src="view/shop/lib/img/product/shope-add1.jpg" alt="shope-add" /></a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    <div class="one-column-add zoom-img">
                        <a href="#"><img src="view/shop/lib/img/product/shope-add2.jpg" alt="shope-add" /></a>
                    </div>
                </div>
            </div>
            ...
            <div class="image-add-area">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    ...
                    <div class="onehalf-add-shope zoom-img">
                        <a href="#"><img src="view/shop/lib/img/product/one-helf1.jpg" alt="shope-add" /></a>
                    </div>
                    <!-- ONEHALF-ADD END -->
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <!-- ONEHALF-ADD START -->
                    <div class="onehalf-add-shope zoom-img">
                        <a href="#"><img src="view/shop/lib/img/product/one-helf2.jpg" alt="shope-add" /></a>
                    </div>
                    <!-- ONEHALF-ADD END -->
                </div>
            </div>
