        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
            <div class="account-info">
              <div class="single-account-info">
                <ul>
                  <li><a href="view/shop/cart/checkoutAddress.php"><i class="fa fa-building"></i><span>My addresses</span> </a></li>
                  <li><a href="view/shop/cart/registration.php"><i class="fa fa-user"></i><span>My personal information</span> </a></li>
                </ul>
              </div>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
            <div class="account-info">
              <div class="single-account-info">
                <ul>
                  <li><a href="view/shop/wishlist/wishlist.php"><i class="fa fa-heart"></i><span>My wishlists</span>  </a></li>
                </ul>
              </div>
            </div>
          </div>
