...
<body class="hold-transition sidebar-mini">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h2 class="headline text-warning">NotFound</h2>
                    </div>
                    <div class="col-sm-6">
            ...
            <div class="error-page">
                ...
                <div class="error-content">
                    ...
                    <p>
                        ...
                        Meanwhile, you may <a href="view/admin/lib/index.html">return to dashboard</a> or try using the search form.
                    </p>
...
<script src="view/admin/lib/dist/js/demo.js"></script>
</body>
</html>
